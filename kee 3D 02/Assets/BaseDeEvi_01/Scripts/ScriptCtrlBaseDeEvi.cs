...
//        catch (System.IO.FileNotFoundException)
        catch
        {
            ...
            string host_DeError = "http://" + ConceptosConocidos.localizacionBase_001 + "/klw/dks_klw";
...
//        string hostUsr = "http://" + ctrlInterfaz.GetComponent<ScriptDatosInterfaz>().usrHost + "/klw/dks_desarrollo";  // Para que se adapte al host en el que se trabaja
        string hostUsr = "http://" + ConceptosConocidos.localizacionBase_001 + "/klw/dks_desarrollo";  // Para que se adapte al host en el que se trabaja
...
//         string urlDestino = "http://localhost/klw/dks_desarrollo/kee/ClientesServWeb/entradaFichero.php";
        string urlDestino = Usuario.GetComponent<ScriptGestionaDAUS>().Dks_madre_host + ScriptConexionDKS.sufijoAccesoAFicherosDks;
        ...
        postForm.AddField("Clave_agente_que_envia", Usuario.GetComponent<ScriptGestionaDAUS>().Dks_madre_key);  // DEl DKS al que esta conectado la interfaz KEE
        postForm.AddField("Localizacion_agente_que_envia", Usuario.GetComponent<ScriptGestionaDAUS>().Dks_madre_host);
        ...
        if (DatosGlobal.niveDebug > 50)
        {
            Debug.Log("Desde enviaFichero IEnumerator - ya envie el fichero");
        }
