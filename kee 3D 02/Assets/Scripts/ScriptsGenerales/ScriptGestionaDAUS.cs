...
public class ScriptGestionaDAUS : MonoBehaviour {
    ...
    public string Dks_madre_key; // Es el key del DKS al que la interfaz esta conectada
    public string Dks_madre_host; // Es el host del DKS al que la interfaz esta conectada
    ...
    void Start () {
        ...
        Dks_madre_key = "gen_esteDks";
        Dks_madre_host = "http://localhost/klw/dks_desarrollo";  // El host del DKS es la localizacion en si Del DKS evidentemente
