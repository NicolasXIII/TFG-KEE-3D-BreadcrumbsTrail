...
/// <summary>
/// //////////////////////////////////////////////////////////////////////////////////////
/// ///////////  Script de control para el manejo de la opcion "SI" en el gameobject "Btn_Consulta_Si_No" para preguntas de SI o NO
...
public class ScriptBtn_Resp_Si : MonoBehaviour
{
    ...
    void OnTriggerStay(Collider other)
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                this.transform.parent.GetComponent<ScriptBtn_Consulta_Si_No>().respuestaUsuario = ScriptBtn_Consulta_Si_No.respUsr_Si;
