...
public class ScriptBtnMenu_N2_1_CtrlInterfaz_audio : MonoBehaviour {
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        this.transform.localScale = ctrlInterfaz.GetComponent<ScriptDatosInterfaz>().escala_BtnMenu_N2_1_CtrlInterfaz_audio_Activado;
    ...
    {
        this.transform.localScale = ctrlInterfaz.GetComponent<ScriptDatosInterfaz>().escala_BtnMenu_N2_1_CtrlInterfaz_audio;
    } // Fin de - void OnTriggerEnter(Collider other) 
