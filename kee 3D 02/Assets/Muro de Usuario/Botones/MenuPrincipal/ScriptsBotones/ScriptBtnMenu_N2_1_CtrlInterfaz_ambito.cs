...
public class ScriptBtnMenu_N2_1_CtrlInterfaz_ambito : MonoBehaviour {
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        this.transform.localScale = ctrlInterfaz.GetComponent<ScriptDatosInterfaz>().escala_BtnMenu_N2_1_CtrlInterfaz_ambito_Activado;
    ...
    {
        this.transform.localScale = ctrlInterfaz.GetComponent<ScriptDatosInterfaz>().escala_BtnMenu_N2_1_CtrlInterfaz_ambito;
    } // Fin de - void OnTriggerEnter(Collider other) 
}
