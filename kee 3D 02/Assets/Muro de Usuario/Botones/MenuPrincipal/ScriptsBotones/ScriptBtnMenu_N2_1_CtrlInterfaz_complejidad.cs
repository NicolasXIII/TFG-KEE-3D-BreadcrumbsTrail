...
public class ScriptBtnMenu_N2_1_CtrlInterfaz_complejidad : MonoBehaviour {
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        this.transform.localScale = ctrlInterfaz.GetComponent<ScriptDatosInterfaz>().escala_BtnMenu_N2_1_CtrlInterfaz_complejidad_Activado;
    ...
    {
        this.transform.localScale = ctrlInterfaz.GetComponent<ScriptDatosInterfaz>().escala_BtnMenu_N2_1_CtrlInterfaz_complejidad;
    } // Fin de - void OnTriggerEnter(Collider other) 
}
