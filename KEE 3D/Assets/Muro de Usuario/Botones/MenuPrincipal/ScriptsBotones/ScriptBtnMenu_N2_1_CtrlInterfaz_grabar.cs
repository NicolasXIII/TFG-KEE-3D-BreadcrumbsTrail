...
public class ScriptBtnMenu_N2_1_CtrlInterfaz_grabar : MonoBehaviour {
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        this.transform.localScale = ctrlInterfaz.GetComponent<ScriptDatosInterfaz>().escala_BtnMenu_N2_1_CtrlInterfaz_grabar_Activado;
    ...
    {
        this.transform.localScale = ctrlInterfaz.GetComponent<ScriptDatosInterfaz>().escala_BtnMenu_N2_1_CtrlInterfaz_grabar;
    } // Fin de - void OnTriggerEnter(Collider other) 
}
