...
public class ScreiptCtrlEviTipo_buscador_00 : MonoBehaviour {
    ...
    void Start()
    {
        ...
        // host = ConceptosConocidos.gen_dks_klw_host;
        host = ConceptosConocidos.gen_dks_klw_host;  // Para que se adapte al host en el que se trabaja
        //  key = "gen_recMaq";
        ...
        // host = ConceptosConocidos.gen_dks_desarrollo_host;  // Para que se adapte al host en el que se trabaja
        //        key = "gen_ventana";
