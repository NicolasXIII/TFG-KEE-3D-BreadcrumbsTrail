...
//    string xPathString_para_nombre = "./kdl:E/kdl:A/kdl:I/kdl:H[text()='http://www.ideando.net/klw/dks_Generic']";  // Lo defino es estar porque se define refiriendo otros string que tienen que estar inicializados  
    string xPathString_para_nombre = "./kdl:E/kdl:A/kdl:I/kdl:H[text()='http://" + DatosGlobal.localizacionBase_001 + "/klw/dks_Generic']";  // Lo defino es estar porque se define refiriendo otros string que tienen que estar inicializados  
    ...
    void Start () {
        ...
        //        xPathString_para_nombre = "./kdl:E/kdl:A/kdl:I[/kdl:K[text()='gen_nombre'] and /kdl:H[text()='http://" + DatosGlobal.localizacionBase_001 + "/klw/dks_Generic']]";
        //        xPathString_para_nombre = "./kdl:E/kdl:A/kdl:I/kdl:H[text()='http://" + DatosGlobal.localizacionBase_001 + "/klw/dks_Generic']";
    ...
    public string[] dameIdentificadorDeNodo(XmlDocument domKDL, XmlNode nodoElemento)
   {
    ...
    public string[] dameAyudaIntDeNodo(XmlDocument domKDL, XmlNode nodoElemento)
    {
        ...
        ListaNodosQueInstancian = dameHijos_N1_QueInstancianA(KDL_Nodo_P, gen_nombre, ConceptosConocidos.gen_dks_Generic_host, manejadorEspNomb);  // Seleccionamos las instancias de nombre
        ...
        ListaNodosQueInstancian = dameHijos_N1_QueInstancianA(KDL_Nodo_P, gen_descripcion, ConceptosConocidos.gen_dks_Generic_host, manejadorEspNomb);  // Seleccionamos las instancias de nombre
        ...
        ListaNodosQueInstancian = dameHijos_N1_QueInstancianA(KDL_Nodo_P, gen_rotulo, ConceptosConocidos.gen_dks_Generic_host, manejadorEspNomb);  // Seleccionamos las instancias de nombre
        if (ListaNodosQueInstancian.Count == 1)
        {
            try
            {
        ...
        ListaNodosQueInstancian = dameHijos_N1_QueInstancianA(KDL_Nodo_P, gen_iconoImagenConcepto, ConceptosConocidos.gen_dks_klw_host, manejadorEspNomb);  // Seleccionamos las instancias de nombre
        if (ListaNodosQueInstancian.Count == 1)
        {
            try
            {
        ...
        ListaNodosQueInstancian = dameHijos_N1_QueInstancianA(KDL_Nodo_P, gen_iconoAudioConcepto, ConceptosConocidos.gen_dks_klw_host, manejadorEspNomb);  // Seleccionamos las instancias de nombre
        if (ListaNodosQueInstancian.Count == 1)
        {
            try
            {
        ...
        ListaNodosQueInstancian = dameHijos_N1_QueInstancianA(KDL_Nodo_P, gen_imagenConcepto, ConceptosConocidos.gen_dks_klw_host, manejadorEspNomb);  // Seleccionamos las instancias de nombre
        if (ListaNodosQueInstancian.Count == 1)
        {
            try
            {
...
//        XmlNodeList ListaNodos_E_en_D = new XmlNodeList();
    ...
    public string dameConceptoBuskedaKeyHost(string key, string host)
    {
        ...
        string aDevolver = "<?xml version='1.0' encoding='UTF-8'?><kdl:C xmlns:kdl='http://kdlnamespace.ideando.net'><kdl:I><kdl:K>gen_efimero_solicitudADks_0</kdl:K><kdl:H>agenteLocal</kdl:H><kdl:Q>1</kdl:Q></kdl:I><kdl:F><kdl:O>0</kdl:O><kdl:M>0</kdl:M></kdl:F><kdl:D><kdl:E><kdl:A><kdl:I><kdl:K>gen_solicitudADks</kdl:K><kdl:H>http://" + DatosGlobal.localizacionBase_001 + "/klw/dks_klw</kdl:H><kdl:Q>0</kdl:Q></kdl:I><kdl:F><kdl:O>0</kdl:O><kdl:M>0</kdl:M></kdl:F><kdl:D><kdl:E><kdl:A><kdl:I><kdl:K>gen_getDetails</kdl:K><kdl:H>http://" + DatosGlobal.localizacionBase_001 + "/klw/dks_klw</kdl:H><kdl:Q>0</kdl:Q></kdl:I><kdl:F><kdl:O>0</kdl:O><kdl:M>0</kdl:M></kdl:F><kdl:D><kdl:E><kdl:A><kdl:I><kdl:K>gen_K</kdl:K><kdl:H>http://" + DatosGlobal.localizacionBase_001 + "/klw/dks_klw</kdl:H><kdl:Q>0</kdl:Q></kdl:I><kdl:F><kdl:O>0</kdl:O><kdl:M>0</kdl:M></kdl:F><kdl:D><kdl:E><kdl:Z><kdl:R><kdl:I><kdl:K>gen_K</kdl:K><kdl:H>http://" + DatosGlobal.localizacionBase_001 + "/klw/dks_klw</kdl:H><kdl:Q>0</kdl:Q></kdl:I><kdl:F><kdl:O>0</kdl:O><kdl:M>0</kdl:M></kdl:F></kdl:R><kdl:T>";
        aDevolver = aDevolver + key;
        aDevolver = aDevolver + "</kdl:T></kdl:Z></kdl:E></kdl:D></kdl:A></kdl:E><kdl:E><kdl:A><kdl:I><kdl:K>gen_H</kdl:K><kdl:H>http://" + DatosGlobal.localizacionBase_001 + "/klw/dks_klw</kdl:H><kdl:Q>0</kdl:Q></kdl:I><kdl:F><kdl:O>0</kdl:O><kdl:M>0</kdl:M></kdl:F><kdl:D><kdl:E><kdl:Z><kdl:R><kdl:I><kdl:K>gen_H</kdl:K><kdl:H>http://" + DatosGlobal.localizacionBase_001 + "/klw/dks_klw</kdl:H><kdl:Q>0</kdl:Q></kdl:I><kdl:F><kdl:O>0</kdl:O><kdl:M>0</kdl:M></kdl:F></kdl:R><kdl:T>";
        aDevolver = aDevolver + host;
        aDevolver = aDevolver + "</kdl:T></kdl:Z></kdl:E></kdl:D></kdl:A></kdl:E></kdl:D></kdl:A></kdl:E><kdl:E><kdl:A><kdl:I><kdl:K>gen_configuracionDeAcceso</kdl:K><kdl:H>http://" + DatosGlobal.localizacionBase_001 + "/klw/dks_klw</kdl:H><kdl:Q>0</kdl:Q></kdl:I><kdl:F><kdl:O>0</kdl:O><kdl:M>0</kdl:M></kdl:F><kdl:D><kdl:E><kdl:A><kdl:I><kdl:K>gen_configuracionDeAcceso</kdl:K><kdl:H>http://" + DatosGlobal.localizacionBase_001 + "/klw/dks_klw</kdl:H><kdl:Q>0</kdl:Q></kdl:I><kdl:F><kdl:O>0</kdl:O><kdl:M>0</kdl:M></kdl:F><kdl:D><kdl:E><kdl:A><kdl:I><kdl:K>gen_configuracionDeAcceso</kdl:K><kdl:H>http://" + DatosGlobal.localizacionBase_001 + "/klw/dks_klw</kdl:H><kdl:Q>0</kdl:Q></kdl:I><kdl:F><kdl:O>0</kdl:O><kdl:M>0</kdl:M></kdl:F><kdl:D><kdl:E><kdl:A><kdl:I><kdl:K>gen_configuracionDeAcceso</kdl:K><kdl:H>http://" + DatosGlobal.localizacionBase_001 + "/klw/dks_klw</kdl:H><kdl:Q>0</kdl:Q></kdl:I><kdl:F><kdl:O>0</kdl:O><kdl:M>0</kdl:M></kdl:F><kdl:D><kdl:E><kdl:Z><kdl:R><kdl:I><kdl:K>gen_numero</kdl:K><kdl:H>http://" + DatosGlobal.localizacionBase_001 + "/klw/dks_Generic</kdl:H><kdl:Q>0</kdl:Q></kdl:I><kdl:F><kdl:O>0</kdl:O><kdl:M>0</kdl:M></kdl:F></kdl:R><kdl:T>0</kdl:T></kdl:Z></kdl:E></kdl:D></kdl:A></kdl:E><kdl:E><kdl:A><kdl:I><kdl:K>gen_idioma_eapa�ol</kdl:K><kdl:H>http://" + DatosGlobal.localizacionBase_001 + "/klw/dks_Languajes</kdl:H><kdl:Q>0</kdl:Q></kdl:I><kdl:F><kdl:O>0</kdl:O><kdl:M>0</kdl:M></kdl:F><kdl:D></kdl:D></kdl:A></kdl:E></kdl:D></kdl:A></kdl:E><kdl:E><kdl:A><kdl:I><kdl:K>gen_configuracionDeAcceso</kdl:K><kdl:H>http://" + DatosGlobal.localizacionBase_001 + "/klw/dks_klw</kdl:H><kdl:Q>0</kdl:Q></kdl:I><kdl:F><kdl:O>0</kdl:O><kdl:M>0</kdl:M></kdl:F><kdl:D><kdl:E><kdl:A><kdl:I><kdl:K>gen_configuracionDeAcceso</kdl:K><kdl:H>http://" + DatosGlobal.localizacionBase_001 + "/klw/dks_klw</kdl:H><kdl:Q>0</kdl:Q></kdl:I><kdl:F><kdl:O>0</kdl:O><kdl:M>0</kdl:M></kdl:F><kdl:D><kdl:E><kdl:Z><kdl:R><kdl:I><kdl:K>gen_numero</kdl:K><kdl:H>http://" + DatosGlobal.localizacionBase_001 + "/klw/dks_Generic</kdl:H><kdl:Q>0</kdl:Q></kdl:I><kdl:F><kdl:O>0</kdl:O><kdl:M>0</kdl:M></kdl:F></kdl:R><kdl:T>1</kdl:T></kdl:Z></kdl:E></kdl:D></kdl:A></kdl:E><kdl:E><kdl:A><kdl:I><kdl:K>gen_idioma_ingles</kdl:K><kdl:H>http://" + DatosGlobal.localizacionBase_001 + "/klw/dks_Languajes</kdl:H><kdl:Q>0</kdl:Q></kdl:I><kdl:F><kdl:O>0</kdl:O><kdl:M>0</kdl:M></kdl:F><kdl:D></kdl:D></kdl:A></kdl:E></kdl:D></kdl:A></kdl:E></kdl:D></kdl:A></kdl:E></kdl:D></kdl:A></kdl:E></kdl:D></kdl:A></kdl:E></kdl:D></kdl:C>";
